...
txt_next = 'Начать'
txt_insruction = ('Данное приложение позволит вам с помощью теста Руфье провести первичную диагностику вашего здоровья. \n'
                  'Проба Руфье представляет собой нагрузочный комплекс, предназначенный для оценки работоспособности сердца при физ. нагрузке. \n'
                  'У испытуемого, находящегося в положении лежа а спине в течение 5 мин, определяют частоту пульса за 15 секунд; \n'
...
txt_hintname = 'Ф.И.О.'
txt_hintage = '0'
txt_test1 = 'Лягте на спину и замерьте пуль за 15 секунд. Нажмите кнопку "Начать первый тест", чтобы запустить таймер. \nРезультат запишите в соответсвующее поле.'
...
Зеленым обозначены секунды, в течении которых необходимо \nпроводить измерения, черным - секунды без замера пульсаций. Реузльтаты запишите в соответсвующие поля.'''
...
txt_res3 = 'средняя. Возможно, стоит дополнительно обслдоваться у врача.'
